function varargout = implicit_misattribution_3rdpart2(varargin)
% IMPLICIT_MISATTRIBUTION_3RDPART2 MATLAB code for implicit_misattribution_3rdpart2.fig
%      IMPLICIT_MISATTRIBUTION_3RDPART2, by itself, creates a new IMPLICIT_MISATTRIBUTION_3RDPART2 or raises the existing
%      singleton*.
%
%      H = IMPLICIT_MISATTRIBUTION_3RDPART2 returns the handle to a new IMPLICIT_MISATTRIBUTION_3RDPART2 or the handle to
%      the existing singleton*.
%
%      IMPLICIT_MISATTRIBUTION_3RDPART2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMPLICIT_MISATTRIBUTION_3RDPART2.M with the given input arguments.
%
%      IMPLICIT_MISATTRIBUTION_3RDPART2('Property','Value',...) creates a new IMPLICIT_MISATTRIBUTION_3RDPART2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before implicit_misattribution_3rdpart2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to implicit_misattribution_3rdpart2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help implicit_misattribution_3rdpart2

% Last Modified by GUIDE v2.5 28-Nov-2015 17:55:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @implicit_misattribution_3rdpart2_OpeningFcn, ...
                   'gui_OutputFcn',  @implicit_misattribution_3rdpart2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before implicit_misattribution_3rdpart2 is made visible.
function implicit_misattribution_3rdpart2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to implicit_misattribution_3rdpart2 (see VARARGIN)

% Choose default command line output for implicit_misattribution_3rdpart2
...
% UIWAIT makes implicit_misattribution_3rdpart2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = implicit_misattribution_3rdpart2_OutputFcn(hObject, eventdata, handles) 
