function varargout = handwash_study_3_1(varargin)
% HANDWASH_STUDY_3_1 MATLAB code for handwash_study_3_1.fig
%      HANDWASH_STUDY_3_1, by itself, creates a new HANDWASH_STUDY_3_1 or raises the existing
%      singleton*.
%
%      H = HANDWASH_STUDY_3_1 returns the handle to a new HANDWASH_STUDY_3_1 or the handle to
%      the existing singleton*.
%
%      HANDWASH_STUDY_3_1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HANDWASH_STUDY_3_1.M with the given input arguments.
%
%      HANDWASH_STUDY_3_1('Property','Value',...) creates a new HANDWASH_STUDY_3_1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before handwash_study_3_1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to handwash_study_3_1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help handwash_study_3_1

% Last Modified by GUIDE v2.5 08-Dec-2015 20:41:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @handwash_study_3_1_OpeningFcn, ...
                   'gui_OutputFcn',  @handwash_study_3_1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before handwash_study_3_1 is made visible.
function handwash_study_3_1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to handwash_study_3_1 (see VARARGIN)

% Choose default command line output for handwash_study_3_1
...
% UIWAIT makes handwash_study_3_1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = handwash_study_3_1_OutputFcn(hObject, eventdata, handles) 
